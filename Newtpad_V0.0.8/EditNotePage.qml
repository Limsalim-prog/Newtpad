    ...
    Rectangle {
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                Rectangle {
                    width: 40; height: 40; radius: 8; color: window.bgCard
                    Text { text: "＋"; font.pixelSize: 16; color: window.txtPrimary; anchors.centerIn: parent }
            ...
            ScrollView {
                ...
                Item {
                    ...
                    height: Math.max(bodyInput.implicitHeight, markdownPreview.implicitHeight, editorScrollView.height - 10)
        ...
        Rectangle {
            ...
            RowLayout {
                ...
                Rectangle {
                    id: btnFolder
                    width: folderLabel.implicitWidth + 30; height: 34; radius: 10
                    color: window.bgCard; border.color: window.borderMain; border.width: 1; Layout.alignment: Qt.AlignVCenter
                    Row {
                        anchors.centerIn: parent; spacing: 6
                        Text { text: "📁"; font.pixelSize: 12 }
                        Text { id: folderLabel; text: editPageRoot.currentCategory; color: window.txtPrimary; font.family: "Monospace"; font.pixelSize: 12 }
                    }
                ...
                Rectangle {
                    id: btnTags
                    width: tagsLabel.implicitWidth + 30; height: 34; radius: 10
                    color: window.bgCard; border.color: window.borderMain; border.width: 1; Layout.alignment: Qt.AlignVCenter
                    Row {
                        anchors.centerIn: parent; spacing: 6
                        Text { text: "🏷️"; font.pixelSize: 12 }
                        Text { id: tagsLabel; text: editPageRoot.currentTags !== "" ? editPageRoot.currentTags : "Tambah Tag"; color: window.txtPrimary; font.family: "Monospace"; font.pixelSize: 12; elide: Text.ElideRight; width: 80 }
                    }
        ...
        ColumnLayout {
            ...
            Rectangle {
                ...
                RowLayout {
                    ...
                    Text { text: "To-Do List"; color: editPageRoot.currentIsTodo ? "#FFFFFF" : window.txtPrimary; font.family: "Monospace"; font.pixelSize: 12 }
                }
                MouseArea {
                    anchors.fill: parent
                    onClicked: {
            ...
            Rectangle {
                ...
                RowLayout {
                    ...
                    Text { text: "Sisipkan Gambar"; color: window.txtPrimary; font.family: "Monospace"; font.pixelSize: 12 }
                }
                MouseArea {
                    anchors.fill: parent
                    onClicked: {
            ...
            Rectangle {
                ...
                RowLayout {
                    anchors.fill: parent; anchors.leftMargin: 10; spacing: 8
                    Text { text: "🎙️"; font.pixelSize: 14 }
                    Text { text: "Voice Note"; color: (voiceAttachment.item && voiceAttachment.item.isRecording) ? "#FFFFFF" : window.txtPrimary; font.family: "Monospace"; font.pixelSize: 12 }
                }
                MouseArea {
                    anchors.fill: parent
                    onClicked: {
            ...
            Rectangle {
                ...
                RowLayout {
                    anchors.fill: parent; anchors.leftMargin: 10; spacing: 8
                    Text { text: editPageRoot.currentPassword === "" ? "🔓" : "🔒"; font.pixelSize: 14 }
                    Text { text: editPageRoot.currentPassword === "" ? "Kunci PIN" : "Ubah PIN"; color: window.txtPrimary; font.family: "Monospace"; font.pixelSize: 12 }
                }
                MouseArea {
                    anchors.fill: parent
                    onClicked: {
            ...
            Rectangle {
                ...
                RowLayout {
                    anchors.fill: parent; anchors.leftMargin: 10; spacing: 8
                    Text { text: "⏰"; font.pixelSize: 14 }
                    Text { text: "Pengingat (Reminder)"; color: window.txtPrimary; font.family: "Monospace"; font.pixelSize: 12 }
                }
                MouseArea {
                    anchors.fill: parent
                    onClicked: {
            ...
            Rectangle {
                ...
                RowLayout {
                    anchors.fill: parent; anchors.leftMargin: 10; spacing: 8
                    Text { text: "🔗"; font.pixelSize: 14 }
                    Text { text: "Bagikan / Ekspor PDF"; color: window.txtPrimary; font.family: "Monospace"; font.pixelSize: 12 }
                }
                MouseArea {
                    anchors.fill: parent
                    onClicked: {
