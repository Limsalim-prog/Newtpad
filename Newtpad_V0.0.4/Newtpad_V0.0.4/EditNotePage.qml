    ...
    ColumnLayout {
        ...
        RowLayout {
            ...
            ListView {
                ...
                delegate: Rectangle {
                    id: tabItem
                    width: Math.max(95, Math.min(135, innerTabText.implicitWidth + 38))
                    height: 35
                    ...
                    Text {
                        id: innerTabText
                        text: {
                            let noteData = notesModel.get(model.noteIndex)
                            if (!noteData) return "Untitled"
                            return noteData.title === "" ? "Untitled" : noteData.title
                        }
                        color: "#FFFFFF"
                    ...
                    Rectangle {
                        ...
                        MouseArea {
                            ...
                            onClicked: {
                                let targetNoteIndex = model.noteIndex
                                let targetActiveIndex = index

                                if (editPageRoot.noteIndex === targetNoteIndex) {
                                    editPageRoot.commitCurrentChanges()
                                }

                                activeTabsModel.remove(targetActiveIndex)

                                if (activeTabsModel.count === 0) {
                                    window.currentEditIndex = -1
                                    editPageRoot.backClicked()
                                } else {
                                    if (editPageRoot.noteIndex === targetNoteIndex) {
                                        let safeIdx = Math.max(0, targetActiveIndex - 1)
                                        let nextTab = activeTabsModel.get(safeIdx)
                                        window.currentEditIndex = nextTab.noteIndex
                                        editPageRoot.noteIndex = nextTab.noteIndex
                                    }
                                }
                            }
                        }
            ...
            Rectangle {
                Layout.preferredWidth: 35
                Layout.preferredHeight: 35
                color: editPageRoot.currentReminder !== "" ? "#F2542D" : "#222222"
                radius: 6
                border.color: "#333333"
                Text { text: "🔔"; font.pixelSize: 14; color: "#FFFFFF"; anchors.centerIn: parent }
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    Text {
                        ...
                        color: editPageRoot.currentReminder !== "" ? "#F2542D" : "#444444"
                        MouseArea { anchors.fill: parent; onClicked: reminderPopup.open() }
                    }
                }
            }
            ...
            Row {
                ...
                Repeater {
                    ...
                    delegate: Rectangle {
                        ...
                        border.color: editPageRoot.currentCategory === modelData ? "#F2542D" : "#333333"
                        border.width: 1
    ...
    Popup {
        ...
        ColumnLayout {
            ...
            Rectangle {
                ...
                TextInput {
                    id: dateInput; anchors.fill: parent; anchors.margins: 10; color: "#FFFFFF"; font.family: "Monospace"; font.pixelSize: 13; verticalAlignment: TextInput.AlignVCenter
                    Component.onCompleted: text = new Date().toISOString().split('T')[0]
                }
            }
                ...
                Rectangle {
                    ...
                    MouseArea {
                        anchors.fill: parent; onClicked: {
                            editPageRoot.currentReminder = ""; editPageRoot.commitCurrentChanges(); reminderPopup.close()
                        }
                    }
                }
                ...
                Rectangle {
                    ...
                    MouseArea {
                        ...
                        onClicked: {
                            ...
                            if (!isNaN(d.getTime())) {
                                editPageRoot.currentReminder = d.getTime().toString()
                                notesModel.setProperty(editPageRoot.noteIndex, "notified", false)
                                editPageRoot.commitCurrentChanges()
                                reminderPopup.close()
                            } else {
                                console.log("Format Tanggal/Jam Salah!")
                            }
                        }
                    }
                }
