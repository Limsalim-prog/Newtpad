...
Popup {
    ...
    ColumnLayout {
        ...
        Text {
            text: pwdRoot.mode === 1 ? "Set PIN / Kata Sandi" : (pwdRoot.mode === 2 ? "Matikan Kunci" : "Catatan Terkunci 🔒")
        ...
        Rectangle {
            ...
            TextField {
                ...
                placeholderText: pwdRoot.mode === 1 ? "Buat PIN / kata sandi..." : "Masukkan PIN / kata sandi..."
